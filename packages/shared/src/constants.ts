...
// Physics
export const GRAVITY = 300; // pixels/s²
...
export const WORM_JUMP_VX = 100;
export const WORM_JUMP_VY = -200;
export const WORM_BACKFLIP_VX = -50;
export const WORM_BACKFLIP_VY = -250;
